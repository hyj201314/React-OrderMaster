...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/home/hanyajie/WebstormProjects/webpack-order-master/node_modules/react-hot-loader/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/home/hanyajie/WebstormProjects/webpack-order-master/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var react_router = __webpack_require__(165);
	...
	var HelpToOrder = __webpack_require__(223);
	var routes = React.createElement(Router, null, React.createElement(Route, { path: '/', component: Main }), React.createElement(Route, { path: 'help_to_order', component: HelpToOrder }));
	ReactDOM.render(routes, document.getElementById('root'));

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/home/hanyajie/WebstormProjects/webpack-order-master/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "app.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".order{\n    color:white;\n    text-align:center;\n    background:black;\n    padding:0%;\n    margin:0%;\n    height: 50px;\n    width: 100%;\n    line-height: 60px;\n    font-size: 23px;\n}\n.help-order-button{\n    margin-top: 30px;\n    color:black;\n    text-align:center;\n    background-color:#f5f5f5;\n    border-radius: 6px;\n    font-size: 18px;\n    border:1px solid #ccc;\n    height: 50px;\n    width: 98%;\n    margin-left: 10px;\n    margin-right: 10px;\n    cursor: pointer;\n    line-height: 50px;\n    background-image: linear-gradient(to bottom,#fff,#e6e6e6);\n}\n.help-order-button:hover{\n    background: linear-gradient(to bottom,#fff,#DEDEDE);\n}\n.look-order-button{\n    color:black;\n    text-align:center;\n    cursor: pointer;\n    background-color: #f5f5f5;\n    border-radius: 6px;\n    font-size: 18px;\n    border :1px solid #ccc;\n    height: 50px;\n    line-height: 50px;\n    width: 98%;\n    margin-left: 10px;\n    margin-right: 10px;\n    background-image: linear-gradient(to bottom,#fff,#e6e6e6);\n}\n.look-order-button:hover {\n    background: linear-gradient(to bottom,#fff,#DEDEDE);\n}\nbody{\n    display: block;\n    margin: 0;\n}\na{\n    color: black;\n    text-decoration: none;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./help_to_order.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./help_to_order.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateBrowserHistory = __webpack_require__(219);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = React.createClass({
	    ...
	    render: function () {
	        return React.createElement('div', null, React.createElement('div', { className: 'order' }, '订餐'), React.createElement('div', { type: 'button', className: 'help-order-button', onClick: this.go_to_help_to_order }, '帮订餐'), React.createElement('div', { type: 'button', className: 'look-order-button', onClick: this.go_to_look_to_order }, '看订餐'));
	    }
	});
	module.exports = Main;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HelpToOrder = React.createClass({
	    ...
	    componentDidMount: function () {
	        ...
	        if (name_value != null && restaurant_value != null && meal_value != null) {
	    ...
	    render: function () {
	        return React.createElement('div', null, React.createElement('div', { className: 'order' }, React.createElement('button', { className: 'back', onClick: this.go_to_main }, 'back'), '订餐'), React.createElement('div', null, React.createElement('h4', { className: 'person' }, '人:'), React.createElement('input', { className: 'input-name', id: 'name_id', value: this.state.input_names, type: 'text', disabled: 'true' }), React.createElement('div', { className: 'choose-person-button', onClick: this.go_to_choose_person }, '选人')), React.createElement('div', null, React.createElement('h4', { className: 'restaurant' }, '餐厅：'), React.createElement('input', { className: 'input-name', id: 'restaurant_id', value: this.state.input_restaurants, type: 'text', disabled: 'true' }), React.createElement('div', { className: 'choose-restaurant-button', onClick: this.go_to_choose_restaurant }, '选餐厅')), React.createElement('div', null, React.createElement('h4', { className: 'meal' }, '套餐：'), React.createElement('input', { className: 'input-name', id: 'meal_id', value: this.state.input_meals, type: 'text', disabled: 'true' }), React.createElement('button', { className: 'choose-meal-button', id: 'button', disabled: this.state.meal_disabled_value, onClick: this.go_to_choose_meal }, '选套餐')), React.createElement('button', { className: 'acknowledgement', id: 'acknowledgement_id', disabled: this.state.disabled_value, onClick: this.check_button_status }, '确认'));
	    }
	});
	module.exports = HelpToOrder;

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/home/hanyajie/WebstormProjects/webpack-order-master/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "help_to_order.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
